...
- The primary UI path is seeded local commerce and the mock KYC/funding disclosure is collapsed; optional browser evidence is explicitly read-only and collapsed. The receipt is the primary success artifact and contains safe price, balance, payment, order, fulfillment, delivery, and reference snapshots.
